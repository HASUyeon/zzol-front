...
const SignInPage = () => {
  ...
  return (
    <div className={clsx("min-h-screen p-[24px]", "flex flex-col items-center justify-center gap-[48px]")}>
      <div className={clsx("bg-slate-200", "w-[50%] aspect-square", "flex items-center justify-center")}>
        로고
      </div>
      <a href={kakaoAuthUrl}>
        <img width="300px" height='auto' src={kakaoLoginImg.src} alt="카카오 로그인"/>
      </a>
    </div>
  );
};
